...
import com.limox.jesus.teambeta_sqlite.Fragments.HelpLogin.HelpLoginFinal_Fragment;
import com.limox.jesus.teambeta_sqlite.Fragments.HelpLogin.HelpLoginPassword_Fragment;
import com.limox.jesus.teambeta_sqlite.Fragments.HelpLogin.StartHelpLogin_Fragment;
...
public class HelpLogin_Activity extends AppCompatActivity implements HomeOfFragments, StartHelpLogin_Fragment.OnStartHelpLoginFragmentListener, HelpLoginPassword_Fragment.OnHelpLoginPasswordFragmentListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.limox.jesus.teambeta_sqlite.R.layout.activity_help_login);
    ...
    public void startFragment(Fragment fragment, boolean addStack, String tag) {
        ...
        ft.replace(com.limox.jesus.teambeta_sqlite.R.id.activity_help_login, mCurrentFragment,tag);
        ft.commit();
    }
