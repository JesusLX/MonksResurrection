...
public class Admins_Activity extends AppCompatActivity implements HomeOfFragments, NavDrawerUtils.OnNavDrawerListener, AdminsDashPosts_Fragment.OnAdminDashPostFragmentListener, PostAdapterRecycler.OnPostViewHolderListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.limox.jesus.teambeta_sqlite.R.layout.activity_admins);
        mDrawerLayout = (DrawerLayout) findViewById(com.limox.jesus.teambeta_sqlite.R.id.activity_admins);
    ...
    public void startFragment(Fragment fragment, boolean addStack, String tag) {
        ...
        ft.replace(com.limox.jesus.teambeta_sqlite.R.id.aa_container, mCurrentFragment, tag);
        ft.commit();
    }
