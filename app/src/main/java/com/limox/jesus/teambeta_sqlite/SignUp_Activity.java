...
import com.limox.jesus.teambeta_sqlite.Fragments.SignUp.SignUpEmail_Fragment;
import com.limox.jesus.teambeta_sqlite.Fragments.SignUp.SignUpUser_Fragment;
import com.limox.jesus.teambeta_sqlite.Fragments.SignUp.StartSignUp_Fragment;
...
public class SignUp_Activity extends AppCompatActivity implements HomeOfFragments, StartSignUp_Fragment.StartSignUpLoginFragmentListener, SignUpEmail_Fragment.SignUpEmailListener, SignUpUser_Fragment.OnSignUpUserFragmentListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.limox.jesus.teambeta_sqlite.R.layout.activity_sign_up);
    ...
    public void startFragment(Fragment fragment, boolean addStack,String tag) {
        ...
        ft.replace(com.limox.jesus.teambeta_sqlite.R.id.activity_sign_up, mCurrentFragment,tag);
        ft.commit();
    }
