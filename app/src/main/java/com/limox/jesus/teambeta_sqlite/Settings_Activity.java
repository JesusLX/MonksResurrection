...
import com.limox.jesus.teambeta_sqlite.Fragments.Settings.StartSettings_Fragment;
...
public class Settings_Activity extends AppCompatActivity implements HomeOfFragments, StartSettings_Fragment.OnStartSettingsListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.limox.jesus.teambeta_sqlite.R.layout.activity_settings);
    ...
    public void startFragment(Fragment fragment, boolean addStack,String tag) {
        ...
        ft.replace(com.limox.jesus.teambeta_sqlite.R.id.activity_settings, mCurrentFragment,tag);
        ft.commit();
    }
