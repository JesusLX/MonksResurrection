...
public class Login_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.limox.jesus.teambeta_sqlite.R.layout.activity_login);
        mTxvSignUp = (TextView) findViewById(com.limox.jesus.teambeta_sqlite.R.id.lgn_txvSignUp);
        mTxvFP = (TextView) findViewById(com.limox.jesus.teambeta_sqlite.R.id.lgn_txvFP);
    ...
    private void initializeClickListener(){
        mClicKListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                switch (view.getId()) {
                    case com.limox.jesus.teambeta_sqlite.R.id.lgn_txvFP:

                        startActivity(new Intent(Login_Activity.this, HelpLogin_Activity.class));
                        break;
                    case com.limox.jesus.teambeta_sqlite.R.id.lgn_txvSignUp:
